...
?>
<link rel="stylesheet" type="text/css" href="/resource/css/layout/two-column-utility.css?v=@VERSION-NUMBER@" media="all" />
...
?>
	...
	<h2>Welcome to <?php echo $application->registry->get("Name"); ?></h2>
	<p>
