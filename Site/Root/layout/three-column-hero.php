...
?>
<link rel="stylesheet" type="text/css" href="/resource/css/layout/three-column-hero.css?v=@VERSION-NUMBER@" media="all" />
<link rel="stylesheet" type="text/css" href="/resource/css/layout/hero.css?v=@VERSION-NUMBER@" media="all" />
...
?>
	...
	<div id="hero">
		<img src="http://dummyimage.com/620x250/ccc/333.gif?v=@VERSION-NUMBER@" alt="Hero Placeholder" />
	</div>
