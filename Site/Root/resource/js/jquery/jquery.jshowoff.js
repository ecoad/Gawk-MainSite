			...
			function addSlideLinks() {
				...
				$.each(gallery, function(i, val) {
					...
					if(config.appendNumber) {
						i++;
						linktext = "<span class=" + config.linkNumberClass + ">" + i + "</span> " + linktext;
					}
					$('<a id="jshowoff-slidelink-'+i+'" class="'+uniqueClass+'-slidelink-'+i+'" href="#null">'+linktext+'</a>').bind('click', {index:i}, function(e){ goToAndPause(e.data.index); return false; }).appendTo('.'+uniqueClass+'-slidelinks');
				});
			};
