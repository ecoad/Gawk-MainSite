	...
	<body>
		<div id="email">
			...
			<div id="email-body">
				...
				<h2><a href="mailto:{EMAIL_ADDRESS}">{FULL_NAME}</a> has responded to feedback:</h2>
				<h3><strong>Subject:</strong>&#09;{SUBJECT}</h3>
				<p><strong>Body:</strong></p>
				<p>{BODY}</p>
				<p>This feedback can be <a href="{SITE_ADDRESS}/admin/general/feedback/view.php?Submit=View&amp;Id={ID}">viewed</a> on the Web site.</p>
			</div>
			<div id="email-footer">
				<p>---</p>
