...
/**
	...
	public function getResponseCookie($responseHeader, $cookieName) {
		//This is very basic
		preg_match('/^Set-Cookie: (.*?);/m', $responseHeader, $cookieString);
		$cookie = parse_url($cookieString[1]);
		$cookie = str_replace("PHPSESSID=", "", $cookie);
		return $cookie;
	}
}